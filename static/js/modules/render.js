...
// 创建消息操作按钮元素（用于动态添加）
export function createMessageActions(role, msgId) {
    const container = document.createElement('div');
    container.innerHTML = buildActionsHtml(role);
    const actionsEl = container.firstElementChild;
    // 绑定事件
...
// 绑定消息操作按钮事件
function bindMessageActions(el, msgId, role, originalText) {
