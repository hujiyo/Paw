...
export class RightSidebar {
    static init() {
        ...
        this.tabsContainer?.addEventListener('click', (e) => {
            ...
            const closeBtn = target.closest('.editor-tab__close');
            if (closeBtn && tab) {
                // 点击关闭按钮
                e.stopPropagation();
    ...
    // 打开文件标签页
    static openFileTab(path, name, content) {
        // 生成唯一 ID
        ...
        // 创建新标签页
        const fileTab = { id: tabId, path, name, content };
...
RightSidebar.fileTabs = new Map();
RightSidebar.activeTabId = 'terminal';
